...
# Env
This app is using ruby 2.3, rails 4.2.6 and rspec 3.4.2
Please run  `bundle install` and run migrations before getting started

# Notes:

The problems are listed here:
`spec/features/testing_outputs.rb`

So you can run the whole test suite and read specs to get introduced to this solution.

There is no controller/view implemented just yet, but thats the trivial part.
